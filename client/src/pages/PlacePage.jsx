    ...
    return (
      <div className="absolute inset-0 bg-white min-h-screen">
        <div className="p-8 grid gap-4">
          <div className="">
            <h2 className="text-2xl mr-48">{place.title}</h2>
            <button onClick={() => setShowAllPhotos(false)} className="fixed right-12 top-8 flex py-2 px-4 rounded-2xl bg-gray-200 shadow-sm shadow-gray-500">
